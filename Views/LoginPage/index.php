...
<body>
            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="#" class="text-nowrap logo-img text-center d-block py-3 w-100">
                  <img src="<?php echo base_url; ?>Assets/admin/images/logos/Logo.png" width="180" alt="">
                </a>
                <p class="text-center">Bienvenidos al Sistema test2</p>
                <form autocomplete="off" id="frmLogin" onsubmit="frmLogin(event);">
                  ...
                  <div class="form-group btn-container">
                    <button class="btn btn-dark w-100 py-8 fs-4 mb-4 rounded-2" type="submit"><i class="fa fa-sign-in fa-lg fa-fw"></i>Iniciar Sesion</button>
                </div>
  ...
  <script src="<?php echo RUTA_PRINCIPAL . 'Assets/admin'; ?>/js/LoginPage.js "></script>
</body>
