...
<div class="container-fluid">
    ...
    <div class="card-body px-4 py-3" style="background-color: #e9f3fe;">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-bold mb-0">Gestion Popup</h4>
            ...
            <div class="col-3 text-end">
                <button class="btn btn-dark mb-2" type="button" onclick="frmModalEmergente()"><i class="ti ti-plus fs-5"></i></button>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" style="width:100%" id="tblModalEmergente">
...
<div class="modal fade" id="nuevoModalEmergente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmModalEmergente" onsubmit="registrarModalEmergente(event)">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="subtitulo" class="form-control" type="text" name="subtitulo" required placeholder="Ingresar Subtitulo">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
